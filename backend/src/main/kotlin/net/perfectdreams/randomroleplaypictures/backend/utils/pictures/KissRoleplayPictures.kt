...
object KissRoleplayPictures : RoleplayPictures("kiss") {
    init {
        ...
        picture("Unknown.gif", BothMatchType) {
            source = AnimeSource("Chicchana Mune no Tokimeki 2nd Season")
        }
        picture("Unknown_2.gif", BothMatchType) {
            source = AnimeSource("Zero no Tsukaima")
        }
        ...
        picture("gif_301.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Yamada-kun to Nananin no Majo")
        }
        picture("gif_302.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Kuroko no basket Fanart")
        }
        ...
        picture("Unknown.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Dakaretai Otoko 1-i Ni Odosarete Imasu")
        }
        ...
        picture("Unknown.gif", FemaleXMaleGenderMatchType) {
            source = AnimeSource("Star Driver: Kagayaki no Takuto")
        }
        ...
        picture("Unknown_5.gif", FemaleXMaleGenderMatchType) {
            source = AnimeSource("Accel World")
        }
        ...
        picture("gif_327.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("Angel Beats")
        }
        ...
        picture("gif_331.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("Chaos Dragon Sekiryuu Seneki")
        }
        picture("gif_332.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("The Yuri Awakens")
        }
        ...
        picture("gif_366.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("Yurikuma Arashi")
        }
        ...
        picture("Unknown.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("Shugo Chara!")
        }
    }
}
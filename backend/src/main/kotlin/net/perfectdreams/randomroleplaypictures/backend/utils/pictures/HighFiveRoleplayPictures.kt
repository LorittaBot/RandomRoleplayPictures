...
object HighFiveRoleplayPictures : RoleplayPictures("high-five") {
    init {
        ...
        picture("high-five-10.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("Sailor Moon")
        }
        picture("high-five-11.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("Houkago Teibou Nisshi")
        }
        picture("high-five-12.gif", FemaleXFemaleGenderMatchType) {
            source = AnimeSource("Love Live! Sunshine!!")
        }
        picture("high-five-13.gif", FemaleXFemaleGenderMatchType) {
        ...
        picture("high-five-11.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Dagashi Kashi")
        }
        picture("high-five-12.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("JoJo no Kimyo na Boken")
        }
        picture("high-five-13.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Haikyuu")
        }
        picture("high-five-14.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Baki")
        }
        picture("high-five-15.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Haikyuu")
        }
        picture("high-five-16.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Boruto")
        }
        picture("high-five-17.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("SK8 the Infinity")
        }
        picture("high-five-18.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("SK8 the Infinity")
        }
        picture("high-five-19.gif", MaleXMaleGenderMatchType) {
            source = AnimeSource("Stars Align")
        }

        picture("high-five-1.gif", GenericMatchType) {
            source = AnimeSource("Hibiki Ganaha")
        }
        picture("high-five-2.gif", GenericMatchType) {
            source = AnimeSource("Pokemon")
        }
        picture("high-five-3.gif", GenericMatchType) {
            source = AnimeSource("Magi")
        }
